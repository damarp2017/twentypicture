<x-app-layout>
    <x-slot name="header">
        <div class="flex justify-between">
            ...
            <div>
                <x-button onclick="location.href='{{ route('banner.create') }}'" style="margin-top: -1rem">Create
                </x-button>
            </div>
        </div>
    </x-slot>
        ...
        <div class="flex flex-wrap px-4 lg:px-4">
            ...
            <div class="my-2 md:px-2 w-full md:w-1/2 lg:my-4 lg:px-2 lg:w-1/3">
                <article class="overflow-hidden rounded-lg shadow-lg">
                    ...
                    <img alt="Placeholder" class="block h-auto w-full" src="{{ $banner->image }}">
                    @else
                    <img alt="Placeholder" class="block h-auto w-full" src="{{ url(Storage::url($banner->image)) }}">
                    @endif
                    ...
                    <footer class="flex items-center justify-end leading-none p-2 md:p-4">
                        <x-button-red onclick="location.href='{{ route('banner.destroy', $banner) }}'">
                            <small>Remove</small>
                        </x-button-red>
                    </footer>
                </article>
